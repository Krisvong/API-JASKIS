...
//1.  Make a new collection called Scavengers.
...
//3.  Find all the Scavengers who joined the team after December 31, 2011.
db.scavengers.find({ joined: { $gte: ISODate("2012-01-01T00:00:00Z") } })
//4.  Find all the Scavengers who helped catch Thanoceros.
db.scavengers.find({ "captured": {"$elemMatch": {"name": "Thanoceros" }}})
//5.  Find all the Scavengers who helped catch an animal bounty with a reward greater than $11000.
db.scavengers.find({
    "captured": {
        $elemMatch: {
            "reward" : { $gt: 11000 },
...
//6.  Find all the Scavengers that do not have weapon.
